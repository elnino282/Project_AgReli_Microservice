...
export function EditFarmModal({
  ...
  const farmers =
    farmersData?.items?.filter((u) => u.roles?.includes("FARMER")) ?? [];
  ...
  const updateMutation = useMutation({
    mutationFn: (data: AdminFarmUpdateRequest) =>
      adminFarmApi.update(farmId, data),
    onSuccess: () => {
                        ...
                        {farmersLoading ? (
                          ...
                          farmers.map((farmer) => (
                            <button
                              ...
                              type="button"
                              onClick={() =>
                                handleSelectOwner(Number(farmer.id))
                              }
                            ...
                            >
                              <div>
                                <div className="font-medium">
                                  {farmer.fullName || farmer.username}
                                </div>
