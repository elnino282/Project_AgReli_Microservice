...
import type { PortalType } from '@/widgets/layout/model/types';
import { Accordion, AccordionContent, AccordionItem, AccordionTrigger } from '@/shared/ui/accordion';
import { BookOpen, ShieldAlert, Briefcase, ChevronRight } from 'lucide-react';
...
export function UserGuideContent({ portalType, embedded = false }: UserGuideContentProps) {
    const navigate = useNavigate();

    return (
        <div className={embedded ? 'w-full space-y-6' : 'w-full space-y-8 p-6'}>
            {!embedded && <div className="pb-4">
            ...
            {(!portalType || portalType === 'FARMER') && (
                <div className={embedded ? 'mb-0' : 'mb-12'}>
